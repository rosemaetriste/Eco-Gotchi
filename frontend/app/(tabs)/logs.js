...
const formatActionCount = (count) => {
  const num = Number(count) || 0;
  return num > 100000 ? "100,000+" : num.toLocaleString();
};
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={sharedStyles.logsHeader}>
        ...
        <View style={sharedStyles.statsGrid}>
          ...
          <View style={sharedStyles.statBox}>
            ...
            <Text style={sharedStyles.statBoxValue}>{formatActionCount(allTimeCount)} actions</Text>
          </View>
        </View>
      </View>
      ...
      <View style={s.tabInfoBar}>
        ...
        <View style={s.tabLogCount}>
          <Text style={s.tabLogCountText}>{formatActionCount(selected.logs.length)} logs</Text>
        </View>
      </View>
    ...
    <ScrollView stickyHeaderIndices={[1]} contentContainerStyle={{ paddingTop: 20, paddingBottom: 30 }}>
      ...
      <View style={sharedStyles.logsHeader}>
        ...
        <View style={sharedStyles.statsGrid}>
          ...
          <View style={sharedStyles.statBox}>
            <Text style={sharedStyles.statBoxLabel}>TOTAL LOGS</Text>
            <Text style={sharedStyles.statBoxValue}>{formatActionCount(logs.length)} actions</Text>
          </View>
        </View>
      </View>
